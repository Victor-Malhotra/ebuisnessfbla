function ResponsiveGridDisplay({ title, children }) {
  return (
    <div className=''>
      ...
      <div className='grid gap-12 items-start justify-center xl:justify-start grid-cols-[repeat(auto-fit,minmax(200px,1fr))] xl:grid-cols-[repeat(auto-fill,minmax(200px,1fr))]'>
